    ...
    <a class="flex items-center text-gray-900 hover:text-gray-900 focus:text-gray-900 mt-2 lg:mt-0 mr-1" href="#">
      ...
      <!-- Left links -->
        ...
        <div class="absolute top-1 right-10 ">
            ...
            <a href="/companyreg" class="inline-block px-6 py-2.5 bg-blue-600 text-white  text-md leading-normal uppercase font-bold rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Register</a>
