<div class="bg-gray-text border-r-2 border-l-2 border-r-letter border-l-letter h-full w-full shadow-2xl col-span-7 px-3 py-6">
  ...
  <div class="bg-white h-8/12 p-6  shadow-2xl rounded-lg py-4 px-4">
    <form action="{{ route('createproperty')}}" method="POST" type="submit"
      class="py-6 px-2 bg-accent-blue h-50 flex flex-col mx-auto shadow-2xl">
      @csrf
      ...
      <div class="p-3 flex flex-col bg-accent-blue">
        ...
        <select name="classification" id="" class="w-50">
          <option value="IT AND COMMUNICATIONS EQUIPMENT" class="text-gray-600">IT AND COMMUNICATIONS EQUIPMENTS
          </option>
      ...
      <div class="p-3 flex flex-col bg-accent-blue">
        ...
        <select name="category" id="" class="w-50">
