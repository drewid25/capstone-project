        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/dashboard" class="bg-button-blue text-white px-3 py-2 rounded-md text-sm font-medium"
                aria-current="page">Dashboard</a>

              <a href="/employeelist"
                class="text-letter hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Employees</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
          ...
          <div class=" ml-3">
            <div class="flex items-center">
              ...
              <form action="/logout" method="post">
                @csrf
                <button
                  class="text-letter ml-3  hover:bg-letter hover:text-accent-blue bg-button-blued px-3 py-2 rounded-md text-sm font-medium">logout</button>
              </form>
            </div>
          </div>
        </div>
