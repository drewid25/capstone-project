    ...
    <div class="flex flex-col justify-center mt-20">
        ...
        font-extrabold text-gray-text">
            ...
            <form action="/user" method="POST" enctype="multipart/form-data" class="mt-6">
                @csrf
                <div class="mb-2">
                    <label for="id_number" class="block text-sm font-semibold text-gray-text">
                        Employee Id Number:
                    </label>
                    <input type="text" onfocus="this.value=''" value="Type Here"
                ...
                <div class="mb-2">
                    <label for="name" class="block text-sm font-semibold text-gray-text">
                        Employee Name:
                    </label>
                    <input type="text"
                        class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full 
                ...
                <div class="mb-2">
                    ...
                    <input type="file"
                        class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full 
                  py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-accent-blue"
                        name="employee_image" value="{{ old('employee_image') }}" required />
                ...
                <div class="mb-2">
                    ...
                    <select name="department" id="department"
                        class="w-50 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full 
             py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-accent-blue form-select bg-no-repeat">
                ...
                <div class="mt-6">
                    <button type="submit"
                        class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-button-blue rounded-md hover:bg-accent-blue focus:outline-none focus:bg-accent-blue">
                        Submit
                    </button>
                </div>
            </form>
