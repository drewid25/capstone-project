<div class="bg-gray-300 border-r-2 border-l-2 border-r-letter border-l-letter h-full shadow-2xl py-10 px-3 col-span-10">
    <h1 class="text-gray-800 font-bold text-2xl mb-3 text-center">Edit Property</h1>

    <form action="{{ url('updateproperty/' . $property->id) }}" method="POST" type="submit"
        class="py-6 px-6 bg-gray-100 h-50 flex flex-col w-8/12 mx-auto shadow-2xl">
        @csrf
        ...
        <div class="flex flex-row">
            <div class="p-3 flex flex-col w-6/12 ">
                ...
                <select name="classification" id=""
                    class="bg-white border-2 border-gray-200 rounded w-full py-0 px-1 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-800"
        ...
        <div class="flex p-3">
            <div class="mb-3 w-full">
                ...
                <textarea
                    ...
                    id="exampleFormControlTextarea1" rows="3" name="description" value={{ $property->description }}>
                      </textarea>
            </div>
        </div>
        <div class="block relative mb-5 px-3">
            ...
            <select id="user" required name="user_id"
                class="bg-white border-2 border-gray-200 rounded w-full py-0 px-2 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-800 ">
        ...
        <div class="text-center mt-5">
            <button
                ...
                type="submit"> <i class="fa-solid fa-window-maximize fa-sm text-gray-100  mr-2 "></i>Submit</button>
