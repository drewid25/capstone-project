<nav class="relative w-full flex flex-wrap items-center justify-between py-4 bg-accent-blue text-gray-500 hover:text-gray-700 focus:text-gray-700 shadow-lg ">
  ...
  <div>
    <a href="/register" class="px-6 pt-2.5 pb-2 bg-blue-600 text-white font-medium text-xs leading-normal uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex align-center">
