<div
  class="bg-gray-text col-span-7 border-r-2 border-l-2 border-r-letter border-l-letter h-full shadow-2xl py-6 px-3  ">
  ...
  <div class="bg-white h-8/12 p-6 w-8/12 mx-auto shadow-2xl rounded-lg py-4 px-4">
    <form action="{{ route('addemployeelist') }}" method="POST" enctype="multipart/form-data" type="submit"
