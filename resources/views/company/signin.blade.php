...
<div class="h-full">
    <div class="flex justify-center mt-32">
        ...
        <div class="p-10 bg-white">
            <h2 class="text-center text-3xl leading-9 font-extrabold text-gray-800">
            ...
            <form action="/login/process" method="POST">
                ...
                <div class="flex justify-center">
                    <div class="lg:w-full md:w-2/3 w-full">
                        ...
                        <input type="text" name="id_number" id="id_number" placeholder="Company Name" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full  
                ...
                <div class="mt-10 flex justify-center">
                    <button type="submit" class="group w-full lg:w-1/3 md:w-2/3 py-2 px-4 mb-2  border border-transparent text-sm leading-5 font-medium 
                            ...
                            focus:shadow-outline-teal active:bg-teal-400 active:outline-none transition-colors duration-200 transform ease-in-out">
                        Sign In
                    </button>
                </div>
