...
<div class="relative top-10 right-0 bottom-0 left-0 w-full h-screen p-4 mx-auto ">
  ...
  <section class="mb-40 mx-8">
    <div class="text-center bg-gray-50 text-gray-800 py-24 px-6">
      <h1 class="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">Property Management <br /><span class="text-blue-600">System</span></h1>
        <p class="text-gray-600 text-center px-56">
