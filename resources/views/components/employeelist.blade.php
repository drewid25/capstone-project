<div class="bg-accent-blue shadow-2xl py-6 px-3 h-full col-span-7 border-r-2 border-l-2 border-r-letter overflow-auto">
    ...
    <div class="bg-white py-6 px-3 h-96 rounded-lg shadow-2xl w-fit">
        <table class="container border-2 border-border-gray  ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class='border-2 border-border-gray text-grey text-left text-sm'>{{$employee->employee_name}}
                    </td>
                    <td class='border-2 border-border-gray text-grey text-left text-sm'>{{$employee->department}}</td>
                    <td class='border-2 border-border-gray text-grey text-left text-sm'>{{$employee->email_address}}
                    </td>
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <h5 class="text-xl font-medium leading-normal text-gray-800"
                                            id="exampleModalLabel">Accountabilities</h5>
                                        <button type="button"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class='border-2 border-border-gray text-grey text-left text-sm'>
                                                        {{$property->property_number}}</td>
                                                    <td class='border-2 border-border-gray text-grey text-left text-sm'>
                                                        {{$property->property_name}}</td>
                                                    <td class='border-2 border-border-gray text-grey text-left text-sm'>
                                                        {{$property->description}}</td>
                                                    <td class='border-2 border-border-gray text-grey text-left text-sm'>
                                                        {{$property->price}}</td>
                                                    <td class='border-2 border-border-gray text-grey text-left text-sm'>
                                                        {{$property->date_acquired}}</td>
    ...
    <div class="text-center mt-8">
        <a href="/addemployee"
            class="bg-letter text-accent-blue p-2 hover:bg-button-blue hover:text-letter  rounded-lg font-bold">ADD NEW
            EMPLOYEE</a>
    </div>
